...
public class FilterUpdateCustomer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FilterUpdateCustomer frame = new FilterUpdateCustomer();
		...
		btnOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case OnlineCustomer:
					...
					CustomerUpdateGui gui = new CustomerUpdateGui();
