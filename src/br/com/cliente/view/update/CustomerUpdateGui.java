package br.com.cliente.view.update;
...
public class CustomerUpdateGui extends JFrame {
	...
	public CustomerUpdateGui() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(CustomerUpdateGui.class.getResource("/br/com/cliente/view/img/onlineshop_78377.png")));
		setResizable(false);
		setTitle("Alterar Cliente Online");
		...
		btnIncluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				OnlineCustomer Oc = new OnlineCustomer(iid, nome, sobrenome, cpf, dataNascimento, salario, rg,
						telefone);
				boolean r = ControllerCustomer.getInstance().Update(Oc);
		...
		btnIncluir.setIcon(new ImageIcon(CustomerUpdateGui.class.getResource("/br/com/cliente/view/img/Chewbacca-icon_34502.png")));
		btnIncluir.setFont(new Font("Dialog", Font.BOLD, 20));

		JButton btnCancelar = new JButton("CANCELAR");
		btnCancelar.setIcon(new ImageIcon(
				CustomerUpdateGui.class.getResource("/br/com/cliente/view/img/darth-mauls-lightsabers_87095(1).png")));
		...
		lblNewLabel.setIcon(
				new ImageIcon(CustomerUpdateGui.class.getResource("/br/com/cliente/view/img/R2D2-icon_34499.png")));
